...
public class Solution {
    ...
    public static void main(String args[]) throws Exception {
        ...
        inventoryManager.blockInventory("p1", 2, "o2");
...
//        Thread.sleep(100);
//        inventoryManager.blockInventory("p1", 2, "o2");
        inventoryManager.confirmOrder("o2");
        System.out.println("Inventory Left::"+inventoryManager.getInventory("p1"));
    }
...
class InventoryManager {
    ...
    private Map<String, ProductInventory> inventoryMap = new HashMap<>();
    private Map<String, BlockedInventory> blockedInventoryMap = new HashMap<>();
    private Queue<BlockedInventory> queue = null;
//    TaskScheduler taskScheduler = new TaskScheduler(this);
    ...
    public void confirmOrder(String orderId) {
        if(blockedInventoryMap.containsKey(orderId)){
...
//                    Long timeToWait = task.getTimeTillBlocked() - currentTime;
                    while ((task.getTimeTillBlocked() - System.currentTimeMillis()) > 0) {
                        Long timeToWait = task.getTimeTillBlocked() - System.currentTimeMillis();
                        System.out.println("Thread going in wait state for time::" + (task.getTimeTillBlocked() - System.currentTimeMillis()));
